...
Differences are only noted in the commentary when they are likely to represent a real difference taking account of the margin of error in the sample-based estimates (see ‘Survey Estimates’ in [Appendix A](#Appendix_A:_Methodology_and_Quality_Information) for further detail).
...
This has decreased since 2020 and 2021, when 58% and 55% of respondents respectively had heard of NISRA.
