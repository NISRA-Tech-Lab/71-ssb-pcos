...
f_embed_ods(df = table_1a_data,
  sheet_title = paste0("Table 1a: Awareness of NISRA, 2009-", current_year),
  tab_name = "awareness_of_nisra")
...
```{r Chart 2, fig.alt = "Bar chart showing a comparison between awareness of NISRA, in dark blue bars, and ONS, in light blue bars. Awareness of ONS has been greater than that of NISRA, with 75% aware of ONS in 2021, and 49% aware of NISRA in 2022."}
...
```{r Chart 7, fig.alt = "Horizontal stacked bar charts showing trust in NISRA, the media, the Civil Service and the NI Assembly."}
...
```{r Chart 9, fig.alt = "Bar chart with trust in NISRA statistics at 85%, compared to 84% for ONS statistics. This is represented by dark blue segments. Distrust (4% for NISRA statistics, 12% for ONS statistics) is represented by light blue segments. Don't know responses are in grey segments - 11% for NISRA, 3% for ONS."}
...
```{r Chart 11, fig.alt = "Vertical bar chart showing belief that statistics produced by each institution are important in understanding the country. 90% for NISRA in 2022, 88% for ONS in 2021."}
...
```{r Chart 13, fig.alt = "Vertical stacked bar chart showing belief that statistics are free from political interference. Belief that NISRA statistics are free from interference is at 82% in 2022 (dark blue segment), compared to 68% for ONS in 2021."}
...
f_embed_ods(df = table_7a_data, 
  sheet_title = paste0("Table 37: Personal information provided to NISRA will be kept confidential, 2014-", current_year),
  tab_name = "confidential_nisra")
...
```{r Chart 15, fig.alt = "Vertical bar chart showing belief that personal information will be kept confidential by institution. In 2022, 92% believed that NISRA would keep personal information confidential (dark blue segment), compared to 89% for ONS in 2021."}
