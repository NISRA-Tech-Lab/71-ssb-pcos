...
```{r banner}
 div(
    div(class = "row", style = "display: flex; margin-left: 0px; margin-right: 0px",
        div(class = "left", img(src = nisra_logo, alt = "NISRA logo")),
        div(class = "middleaostats", if(statistic_type == "aos") { img(src = aoStats, alt = "Accredited Official Statistics Logo")} ),
        div(class = "right", img(src =  dep_logo, alt = "DoF logo"))),
    
    div(class = "row", style = "display: flex;  margin-left: 0px; margin-right: 0px",
        div(class = "left"),
        div(class = "middle", p("Background Quality Report-", style = "margin: 0"),
            p("Public Awareness of and Trust in", style = "margin: 0"),
            p("Official Statistics, Northern Ireland", style = "margin: 0")),
        div(class = "right")),
...
<div style="padding: 15px; border: 1px solid transparent; border-color: #000000; margin-bottom: 20px; border-radius: 4px; color: #000000; background-color: #FFFFFF; border-color: #000000;">
...
**_Trade-offs are the extent to which different aspects of quality are balanced against each other._**
...
**_The procedures and policy used to ensure sound confidentiality, security and transparent practices._**
