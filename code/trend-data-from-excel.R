...
chart_5_data <- read.xlsx(paste0(data_folder, "PCOS 2022 Charts.xlsx"), sheet = "Chart6", startRow = 3) %>%
  t() %>% as.data.frame() %>%
  mutate(year = as.numeric(rownames(.)),
         trust = as.numeric(`3`),
...
chart_8_data <- read.xlsx(paste0(data_folder, "PCOS 2022 Charts.xlsx"), sheet = "Chart 10", startRow = 3) %>%
  t() %>% as.data.frame() %>%
  mutate(year = as.numeric(rownames(.)),
         trust = as.numeric(`3`),
         distrust = as.numeric(`2`),
...
chart_10_data <- read.xlsx(paste0(data_folder, "PCOS 2022 Charts.xlsx"), sheet = "Chart 13", startRow = 3) %>%
  t() %>% as.data.frame()  %>%
  mutate(year = as.numeric(rownames(.)),
         agree = as.numeric(`3`),
...
chart_12_data <- read.xlsx(paste0(data_folder, "PCOS 2022 Charts.xlsx"), sheet = "Chart 16", startRow = 3) %>%
  t() %>% 
  as.data.frame() %>%
  mutate(year = as.numeric(rownames(.)),
         agree = as.numeric(`3`),
...
chart_14_data <- read.xlsx(paste0(data_folder, "PCOS 2022 Charts.xlsx"), sheet = "Chart 18", startRow = 3) %>%
  t() %>%
  as.data.frame() %>%
  mutate(year = as.numeric(rownames(.)),
         agree = as.numeric(`3`),
