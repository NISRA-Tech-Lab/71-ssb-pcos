...
\
1. `r f_red_text("Almost half of respondents")` (`r heard_of_nisra`%) indicated they had heard of NISRA before being contacted about the survey. 

\
**Value** 

\
2. Statistics produced by NISRA are valued - `r f_red_text("9 out of 10")` respondents (`r importance_of_stats`%) agree that statistics produced by NISRA are important to understand Northern Ireland. 

\
**Political Interference** 

\
3. `r f_red_text("Over four-fifths")` (`r free_from_interference`%) of respondents believe that statistics produced by NISRA are free from political interference.
:::
...
1. The ‘Public Awareness of and Trust in Official Statistics, Northern Ireland `r current_year`’ publication, data tables and accompanying infographics can be found at: [`r f_format_link(paste0("https://www.nisra.gov.uk/publications/public-awareness-and-trust-official-statistics-", current_year))`](https://www.nisra.gov.uk/publications/public-awareness-and-trust-official-statistics-`r current_year`)
\
...
\
1. [`r f_format_link("NISRA produces official statistics for Northern Ireland")`](https://www.nisra.gov.uk/statistics) on a wide range of issues, including births, deaths and marriages; the size of the population of Northern Ireland; qualifications of school leavers; recorded levels of crime; hospital waiting times; people living in poverty; the NI Census; journeys made by walking, cycling or public transport; and the unemployment rate.
\
...
\
1. The [`r f_format_link("Code of Practice for Statistics")`](https://code.statisticsauthority.gov.uk/the-code/), produced by the Office for Statistics Regulation (OSR),outlines the principles and detailed practices that producers of official statistics must commit to when producing and releasing official statistics. It is based on three pillars:
:::
...
\
9. Follow NISRA on [`r f_format_link("Twitter")`](http://x.com/NISRA), [`r f_format_link("Facebook")`](https://www.facebook.com/nisra.gov.uk) and [`r f_format_link("YouTube")`](https://www.youtube.com/user/nisrastats)
:::
