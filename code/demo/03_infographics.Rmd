...
### Type the title of infographic here (h3) {#infographics1 .tabset .tabset-pills}

#### Infographics output
```{r, echo = FALSE, warnings = FALSE, fig.alt = "Population increase from 2018 to 2043 due to relative contributions of natural change and net migration.", out.width="100%"}

#file is in image folder
infographics_1 = 'knitr::include_graphics("../demo/demo_data/images/PopInfographic.png")'

eval(str2expression(infographics_1))
```
