 ...
 * Table 1: Awareness of NISRA, 2009-`r current_year`
 * Table 2: Awareness of NISRA (`r current_year`) and ONS (`r ons_year`)

__Awareness of NISRA statistics among those who had not previously heard of NISRA__

* Table 3: Aware of NISRA statistics on the number of deaths in Northern Ireland, `r current_year`
* Table 4: Aware of NISRA statistics on recorded levels of crime in Northern Ireland, `r current_year`
