...
[Detailed tables](https://www.nisra.gov.uk/publications/public-awareness-and-trust-official-statistics-%60r%20current_year%60) are published alongside this report. These include the source data for all the charts and commentary and additional breakdowns (see [Appendix B](public-awareness-of-and-trust-in-official-statistics-northern-ireland-%60r%20current_year%60-appendix-b.html) for a list of tables).
...
Just under half of respondents (`r heard_of_nisra`%) said they had heard of NISRA before being contacted about the survey. A more detailed breakdown is available in the accompanying tables (see [Appendix B](https://datavis.nisra.gov.uk/techlab/drpvze/public-awareness-of-and-trust-in-official-statistics-northern-ireland-2022-appendix-b.html)).
...
`r f_embed_xl(df = table_1a_data, sheet_title = paste0("Table 1: Awareness of NISRA, 2009-", current_year), tab_name = "awareness_of_nisra")`
...
`r f_embed_xl(df = table_1b_data, sheet_title = paste0("Table 2: Awareness of NISRA (", current_year, ") and ONS (",  ons_year, ")"), tab_name = "awareness_of_nisra_and_ons")`
...
[Tables 2.1a - 2.1j: Awareness of NISRA statistics among those who had not previously heard of NISRA](public-awareness-of-and-trust-in-official-statistics-northern-ireland-%60r%20current_year%60-appendix-b.html#awareness-of-nisra-statistics-among-those-who-had-not-previously-heard-of-nisra)
...
[Tables 2.2a - 2.2j: Awareness that specified statistics are produced by NISRA statisticians among those who were aware of NISRA](public-awareness-of-and-trust-in-official-statistics-northern-ireland-%60r%20current_year%60-appendix-b.html#awareness-that-specified-statistics-are-produced-by-nisra-statisticians-among-those-who-were-aware-of-nisra)
...
`r f_embed_xl(df = table_3.1a_data, sheet_title = paste0("Table 23: Trust in NISRA, 2014-", current_year), tab_name = "trust_nisra")`
...
`r f_embed_xl(df = table_3.1b_data, sheet_title = paste0("Table 24: Trust in NISRA (", current_year, ") and ONS (", ons_year, ")"), tab_name = "trust_nisra_ons")`
...
[Tables 3.2 - 3.4: Trust in institutions](public-awareness-of-and-trust-in-official-statistics-northern-ireland-%60r%20current_year%60-appendix-b.html#trust-in-the-civil-service)
...
`r f_embed_xl(df = table_4a_data, sheet_title = paste0("Table 29: Trust in NISRA Statistics, 2014-", current_year), tab_name = "trust_stats")`
...
`r f_embed_xl(df = table_4b_data, sheet_title = paste0("Table 30: Trust in NISRA (", current_year, ") and ONS (", ons_year, ") statistics"), tab_name = "trust_nisra_ons_stats")`
...
`r f_embed_xl(df = table_5a_data, sheet_title = paste0("Table 32: Statistics produced by NISRA are important to understand Northern Ireland, 2016-", current_year), tab_name = "value_nisra")`
...
`r f_embed_xl(df = table_5b_data, sheet_title = paste0("Table 33: Statistics produced are important to understand our country (NISRA ", current_year, ") and ONS ", ons_year, ")"), tab_name = "trust_nisra_ons_stats")`
...
`r f_embed_xl(df = table_6a_data, sheet_title = paste0("Table 35: Statistics produced by NISRA are free from political interference, 2014-", current_year), tab_name = "political_nisra")`
...
`r f_embed_xl(df = table_6b_data, sheet_title = paste0("Table 36: Statistics produced are free from political interference (NISRA ", current_year, " and ONS ", ons_year, ")"), tab_name = "political_nisra_ons")`
...
`r f_embed_xl(df = table_7a_data, sheet_title = paste0("Table 37: Personal information provided to NISRA will be kept confidential, 2014-", current_year), tab_name = "confidential_nisra")`
...
`r f_embed_xl(df = table_7b_data, sheet_title = paste0("Table 38: Personal information provided will be kept confidential (NISRA ", current_year, " and ONS ", ons_year, ")"), tab_name = "confidential_nisra_ons")`
...
-   [Summary infographics](https://www.nisra.gov.uk/publications/public-awareness-and-trust-official-statistics-2022)
...
-   [Public Confidence in Official Statistics (ONS)](http://natcen.ac.uk/our-research/research/public-confidence-in-official-statistics/)
...
[Detailed tables](https://www.nisra.gov.uk/publications/public-awareness-and-trust-official-statistics-%60r%20current_year%60) including the source data for all the charts and commentary and additional breakdowns are published alongside this report. A full list of tables is provided below:

See [this link for full list of Detailed Tables](public-awareness-of-and-trust-in-official-statistics-northern-ireland-%60r%20current_year%60-appendix-b.html)

`r f_borderline()`

## Appendix C: Survey Questions

The following questions were included in the Continuous Household Survey (CHS) between September and December 2022:

[Public Awareness and Trust in Official Statistics Questions (2022)](public-awareness-of-and-trust-in-official-statistics-northern-ireland-%60r%20current_year%60-appendix-c.html)
